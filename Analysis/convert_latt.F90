...
!--------------------------------------------------------------------
  ...
  use ana_mod, only: read_latt, write_obs_latt_hdf5
  Implicit none
  ...
  Complex (Kind=Kind(0.d0)), pointer     :: bins0(:,:)
  Type (Lattice)                         :: Latt
  ...
  call read_latt(File_in, sgn, bins, bins0, Latt, Latt_unit, dtau, Channel)
  
  write(*,*) "writing to ", File_h5
  call write_obs_latt_hdf5(File_h5, File_in, sgn, bins, bins0, Latt, Latt_unit, dtau, Channel)
  deallocate( sgn, bins, bins0 )
