...
!
      ...
      Integer :: i, j, n, opn, Ndim, info, lwork
!
      Do opn = 1, 4
      lwork = 2*opn
         Allocate (V(opn, 5), P(opn), U(opn, opn), work(lwork), Tau(opn), Uold(opn, opn), E(opn), myTMP(opn, opn))
         Ndim = 5
         Do i = 1, Ndim
            Do j = 1, Ndim
...
! write (*, *) (matnew)
         Do i = 1, Ndim
            ...
            End Do
         End Do
         Deallocate (V, P, U, TAU, work, uold, E, mytmp)
      End Do
      write (*,*) "success"
