...
!--------------------------------------------------------------------
   ...
   subroutine set_hopping_parameters_square_ob(this, Ham_tx_vec, ham_ty_vec, Ham_Chem_vec, &
      ...
      ! Local
      integer :: n, nf, N_Bonds, nc, I, I1, no, ix, iy, si, sj, idx, idy, nr
      ...
      do nf = 1, N_FL
         this(nf)%N_bonds = 2*latt_unit%norb
      ...
      no = 0
      do nf = 1, 4
         do nr = 1, Latt_unit%Norb/2
            no = no + 1
            this(1)%L_Fam(Nf) = this(1)%L_Fam(Nf) + 1
            this(1)%List_Fam(Nf, this(1)%L_Fam(Nf), 1) = 1 ! Unit cell
            this(1)%List_Fam(Nf, this(1)%L_Fam(Nf), 2) = no ! The bond (See above)
         enddo
      enddo

   end subroutine set_hopping_parameters_square_ob
