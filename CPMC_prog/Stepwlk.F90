...
contains
   ...
   subroutine half_K_propagation(phi_trial, phi_0, GR)
      ...
      complex(Kind=kind(0.d0)) :: det_Vec(N_FL), log_o_new(n_hfb), log_o_old(n_hfb)
   ...
   subroutine rescale_overlap(overlap_in)
      ...
      real(Kind=kind(0.d0)) :: log_o_abs(n_hfb), log_o_phase(n_hfb), dz2
