    submodule(Hamiltonian_main) ham_bose_metal_ob_smod
       ...
       type, extends(ham_base) :: ham_bose_metal_ob
       contains
...
#endif
       end type ham_bose_metal_ob

       !#PARAMETERS START# VAR_lattice
       character(len=64) :: Model = "bose_metal_ob"  ! Value not relevant
       character(len=64) :: Lattice_type = "square_ob"
       ...
       !#PARAMETERS START# VAR_bose_metal_ob
    ...
    contains
       ...
       module subroutine Ham_Alloc_bose_metal_ob
          allocate (ham_bose_metal_ob::ham)
       end subroutine Ham_Alloc_bose_metal_ob
...
#include "Hamiltonian_bose_metal_ob_read_write_parameters.F90"
...
!--------------------------------------------------------------------
       subroutine Ham_Hop
          ...
          case ("square_ob")
            call set_hopping_parameters_square_ob(Hopping_Matrix, ham_tx_vec, ham_ty_vec, Ham_Chem_vec, &
...
!--------------------------------------------------------------------
    ...
    end submodule ham_bose_metal_ob_smod
