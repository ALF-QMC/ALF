    submodule(Hamiltonian_main) ham_bose_metal_ladder_smod
       ...
       type, extends(ham_base) :: ham_bose_metal_ladder
       contains
...
#endif
       end type ham_bose_metal_ladder

       !#PARAMETERS START# VAR_lattice
       character(len=64) :: Model = "bose_metal_ladder"  ! Value not relevant
       character(len=64) :: Lattice_type = "N_leg_ladder"
       integer            :: L1 = 6   ! Length in direction a_1
       integer            :: L2 = 2   ! Length in direction a_2
       !#PARAMETERS END#
    ...
    contains
       ...
       module subroutine Ham_Alloc_bose_metal_ladder
          allocate (ham_bose_metal_ladder::ham)
       end subroutine Ham_Alloc_bose_metal_ladder
...
#include "Hamiltonian_bose_metal_ladder_read_write_parameters.F90"
...
!-------------------------------------------------------------------
       subroutine obser(GR,GR_mix,i_wlk,i_grc,sum_w,sum_o,act_mea)
          ...
          complex(Kind=kind(0.d0)) :: Zrho, Zkin, ZPot, Z, ZP, ZS, ZZ, ZXY, zback, zw, z_fac
