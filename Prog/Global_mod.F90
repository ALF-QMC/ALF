...
!--------------------------------------------------------------------
      Subroutine Global_Tempering_setup
        ...
        N = 1
        Filename = "Acc_Temp"
        Call Tempering_acceptance%make(N,Filename)
...
!--------------------------------------------------------------------
      ...
      Subroutine Global_Tempering_init_obs
        Call Tempering_acceptance%Init()
...
!--------------------------------------------------------------------
      ...
      Subroutine Global_Tempering_obser(toggle)
        ...
        if (toggle) then
          call Tempering_acceptance%measure( [cmplx(1.d0,0.d0,kind(0.d0))] )
        else
          call Tempering_acceptance%measure( [cmplx(0.d0,0.d0,kind(0.d0))] )
        endif
...
!--------------------------------------------------------------------
      Subroutine Global_Tempering_Pr
        Implicit none
        Call Tempering_acceptance%print_bin(Group_Comm)
