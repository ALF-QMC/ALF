...
!-------------------------------------------------------------------
    ...
    select case(maxgh) ! weights calculated from here: https://keisan.casio.com/exec/system/1281195844
        ...
        case(6)
            Phi_st(1,2) = 0.3142403762543591112766
            gama_st(1,2) = 0.5701352362624795783471
            
            Phi_st(2,2) = 0.947788391240163743705
            gama_st(2,2) = 0.2604923102641611292334
            
            Phi_st(3,2) = 1.59768263515260479671
            gama_st(3,2) = 0.05160798561588392999187

            Phi_st(4,2) = 2.279507080501059900188
            gama_st(4,2) = 0.00390539058462906185999
            
            Phi_st(5,2) = 3.020637025120889771711
            gama_st(5,2) = 8.57368704358785865457E-5
            
            Phi_st(6,2) = 3.889724897869781919272
            gama_st(6,2) = 2.65855168435630160602E-7
        case default
