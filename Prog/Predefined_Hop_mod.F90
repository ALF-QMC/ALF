...
!--------------------------------------------------------------------
   ...
   subroutine set_hopping_parameters_pi_flux_qbt(this, Ham_T_vec, Ham_T2_vec, Ham_Chem_vec, Phi_X_vec, Phi_Y_vec, Bulk,  N_Phi_vec, N_FL, &
   ...
   end subroutine set_hopping_parameters_pi_flux_qbt
