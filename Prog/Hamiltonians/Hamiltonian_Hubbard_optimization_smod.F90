...
!--------------------------------------------------------------------
    ...
    submodule (Hamiltonian_main) ham_Hubbard_optimization_smod
      ...
      type, extends(ham_base) :: ham_Hubbard_optimization
      contains
...
#endif
      end type ham_Hubbard_optimization
    ...
    contains
      ...
      module Subroutine Ham_Alloc_Hubbard_optimization
        allocate(ham_Hubbard_optimization::ham)
...
#include "Hamiltonian_Hubbard_optimization_read_write_parameters.F90"
...
!--------------------------------------------------------------------
      Subroutine Ham_Set
          ...
          If (Irank_g == 0) then
             ...
             Write(unit_info,*) '====================================='
             Write(unit_info,*) 'Model is      : Hubbard_optimization'
