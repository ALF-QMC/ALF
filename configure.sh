...
GNUDEVFLAGS="-Wconversion -Werror -Wall -fcheck=all -g -fbacktrace -fmax-errors=10"
GNUDEVFLAGS="${GNUDEVFLAGS} -ffpe-trap=invalid,zero,overflow"  #  denormal,underflow can cause too many traps, so not included here
