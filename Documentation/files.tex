...
Sequential_MALA           = .F.   ! Squential MALA updates. Requires continuous fields
Delta_t_MALA_sequential   = 0.1d0 ! Time step for sequential MALA updates
Max_Force_MALA_sequential = 1.d0  ! Maximum force for sequential MALA updates

Global_tau_MALA_moves     = .F.   ! Allows for global tau MALA updates
N_Global_tau_MALA         = 0     ! Number of global tau MALA moves
Delta_t_MALA_global_tau   = 0.1d0 ! Time step for global tau MALA updates
Max_Force_MALA_global_tau = 1.d0  ! Maximum force for global tau MALA updates

Global_MALA_moves         = .F.   ! Allows for global MALA updates
N_Global_MALA_sweeps      = 1     ! Number of global MALA sweeps
Delta_t_MALA_global       = 0.1d0 ! Time step for global MALA updates
Max_Force_MALA_global     = 1.d0  ! Maximum force for global MALA updates
/
...
For converting plain-text output to HDF5, see Sec.~\ref{sec:convert_to_hdf5}.
