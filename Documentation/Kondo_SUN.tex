...
The pyALF script used to produce the data of  the plot can be found in \href{https://github.com/ALF-QMC/pyALF/blob/\pyALFbranch/Scripts/Kondo.py}{\texttt{Kondo.py}}  }
