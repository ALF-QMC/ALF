...
\subsection{SU(N) Kondo lattice models \texttt{Hamiltonian\_Kondo\_smod.F90}}  \label{sec:kondo}
...
The pyALF script used to produce the data of  the plot can be found in \href{https://git.physik.uni-wuerzburg.de/ALF/ALF/-/blob/\ALFbranch/Documentation/Figures/Kondo/Kondo.py}{\texttt{Kondo.py}}.  }
