...
will be useful.  If you benefit from this code  we ask that you acknowledge  the ALF collaboration  as mentioned on our website \url{https://alf.physik.uni-wuerzburg.de}. The git repository at \url{https://github.com/ALF-QMC/ALF} gives us the tools to create a small but vibrant community around the code and provides a suitable entry point for future contributors and future developments. 
