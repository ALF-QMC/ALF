...
\newcommand{\ALFver}{2.4}          %{2.2}{dev.} version of ALF this document refers to
\newcommand{\ALFbranch}{ALF-2.4}   %{ALF-2.2}{master} corresponding ALF branch
\newcommand{\pyALFver}{2.3}        %{2.2}{dev.} version of pyALF that works with \ALFver
\newcommand{\pyALFbranch}{ALF-2.3} %{ALF-2.2}{master} corresponding pyALF branch
\newcommand{\tutALFver}{2.2}       %{2.2}{dev} version of the tutorial - normally should be the same as \ALFver (ex.: 2.2, dev [NO PERIOD AFTER "DEV", SINCE IT'S ALSO USED IN PATHS])
