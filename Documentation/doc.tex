...
\newcommand{\tutALFver}{2.3}       %{2.2}{dev} version of the tutorial - normally should be the same as \ALFver (ex.: 2.2, dev [NO PERIOD AFTER "DEV", SINCE IT'S ALSO USED IN PATHS])
