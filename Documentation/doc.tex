...
\newcommand{\ALFver}{2.3}          %{2.2}{dev.} version of ALF this document refers to
\newcommand{\ALFbranch}{ALF-2.3}   %{ALF-2.2}{master} corresponding ALF branch
\newcommand{\pyALFver}{2.2}        %{2.2}{dev.} version of pyALF that works with \ALFver
