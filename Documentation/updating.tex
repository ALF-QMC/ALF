...
\begin{table}[h]
	\begin{tabular}{@{} p{0.22\columnwidth}  p{0.35\columnwidth}  p{0.35\columnwidth} @{}}
		...
		\texttt{Propose\_MALA}   & Delta\_t\_MALA\_sequential     &  S0, Ham\_Langevin\_HMC\_S0\_single \\
		...
		\texttt{Global\_tau\_MALA\_moves} & N\_Global\_tau\_MALA, Nt\_sequential\_start, Nt\_sequential\_end, Delta\_t\_MALA\_global\_tau    & Global\_Langevin\_move\_tau, Overide\_global\_tau\_sampling\_parameters, Ham\_Langevin\_HMC\_S0\_single \\
		...
		\texttt{MALA}                & N\_MALA\_sweeps, Delta\_t\_MALA\_global    &  Global\_MALA\_move, Delta\_S0\_global, Ham\_Langevin\_HMC\_S0 \\
