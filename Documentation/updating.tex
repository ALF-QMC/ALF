...
\begin{table}[h]
	\begin{tabular}{@{} p{0.45\columnwidth}  p{0.35\columnwidth}  p{0.15\columnwidth}  @{}}
		...
		Global space-time, discrete            &      User defined            & \ref{sec:global_space_time} \\
...
\subsubsection{User specified global moves in space and time : Metropolis}
\label{sec:global_space_time}
...
\subsubsection{User specified global moves in space and time : MALA}
\begin{lstlisting}[style=fortran]
&VAR_QMC
......
Sequential       = .T.       ! Flag for sequential moves
Propose_MALA     = .T.       ! For MALA updates 
N_Global         = 6         ! Number of global moves in space and time
......
/
\end{lstlisting}
