...
The \emph{ALF} (\emph{A}lgorithms for \emph{L}attice \emph{F}ermions)\\project release 2.1\\
...
One can download the code from our Git instance at \url{https://git.physik.uni-wuerzburg.de/ALF/ALF/-/tree/ALF-2.1} and sign in to file issues.} \\
