...
The following commands can be executed in a Debian-based shell in order to install ALF 2.1 and its dependencies, run a demonstration simulation and output one of the measurements performed:
