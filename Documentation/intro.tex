...
In Sec.~\ref{sec:running}   we provide details on running the code  using the shell.  As an alternative the user can download a separate project, \href{https://github.com/ALF-QMC/pyALF/tree/\pyALFbranch}{pyALF}   that provides a convenient python interface as well as  Jupyter  notebooks. 
