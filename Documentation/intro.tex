...
The definition of the Hamiltonian renders the ALF-package unique since it allows for the simulation of a large class of model  Hamiltonians  (see Sec.~\ref{sec:model_classes}  for a selection). The other  open source implementation of the auxiliary field QMC approach, QUEST \cite{Quest2010}   concentrates  on Hubbard models. 
