...
$\ve{j}$   corresponds to the unit-cell index and $n_{\ve{j}}$    labels the orbital.   Recall  that   $  \langle \langle \bullet \rangle \rangle_C $   corresponds  to   the    expectation value  of  an  observable  for a  given  configuration of  fields  $C$  and  not  to the connected   part  of  the  observable. 
...
Note  that  the  background   is  stored  in      e.g. $ \texttt{ObsZ0}\left(n_{\ve{i}} \right) $.    
...
\end{equation}
The   function is   particularly  useful  to  compute  the    total  energy  of  the model  at hand. 
