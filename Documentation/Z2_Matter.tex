...
Ising  $\hat{Q}_{\ve{i}}$  variables.    The pyALF python script that produces this data can be found in  \href{https://github.com/ALF-QMC/pyALF/blob/\pyALFbranch/Scripts/Z2_Matter.py}{\texttt{Z2\_Matter.py}}.
