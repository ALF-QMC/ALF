...
We  conclude  this     section by  comparing  the   generic   projector  QMC code    where  the imaginary  time propagation  is   carried out  with   the 
Hamiltonian  and  the  adiabatic   scheme   in   which  the interaction is  adiabatically  switched on according  to  Fig.~\ref{U_profile.fig}.   

\begin{figure}
\center 
\includegraphics[width=0.49\textwidth]{Figures/Adiabatic/Ener_adiabatic.pdf}
\includegraphics[width=0.49\textwidth]{Figures/Adiabatic/Spin_adiabatic.pdf}
        \caption{   Simulations of  the  Hubbard model   with  adiabatic   (Fig.~\ref{U_profile.fig})   switching   and  Hamilton propagation.    Left: Energy. Right: Spin-spin correlations  at wave  vector $(\pi,\pi)$.  The  Exact 
        results stem  from  \cite{Parola91}.    }
        \label{Adiabatic.fig}
\end{figure}
