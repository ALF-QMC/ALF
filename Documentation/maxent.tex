...
\end{equation}
The code  samples  $n(x)$ corresponding and   at  the  end,  builds  the    spectral  function:
\begin{equation}
...
the  interested  reader  is  referred  to Refs.~\cite{Jarrell96,Linden95}   for  detailed  accounts.  \red{FA: How  detailed  
