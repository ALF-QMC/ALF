...
We note that although formally correct, the method of Ref.~\cite{Grover13} suffers from fat tails in the strong coupling limit and for large subsystems $A$. We have recently witnessed major improvements for the computation of R\'enyi entropies 
\cite{Demidio24,Pan23} based on an incremental approach. It is beyond the scope of this version of the ALF library to provide a generic implementation of these new approaches.
