...
\address{Institut f\"ur Theoretische Physik und Astrophysik, Universit\"at W\"urzburg, 97074 W\"urzburg, Germany}
%---------------------------------------------------------------------------------------------------------
...
Next, we present a number of update strategies, namely local updates and global updates (Sec.~\ref{sec:updating}). 
...
\mycomment{MB: I think we should  acknowledge also RRZE Erlangen: We equally thank G.~Hager, M.~Wittmann, and G.~Wellein for useful discussions and support.}
