...
\footnote{The physical reason of the autocorrelation times can be used to define an improved estimated for the spin correlation function that restores the $SU(2)$ symmetry explicitly. This way, global spin rotations are no longer an issue such that this observable shows the shortest autocorrelation time. Other ways to tackle large autocorrelation can be global updates or parallel tempering.}
