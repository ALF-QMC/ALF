...
it has to be noted that, even with this stabilization scheme, the algorithm preserves the time complexity class of $\mathcal{O}(\beta N^3)$ expressed in the physical parameters of inverse temperature $\beta$ and of lattice size $N$.
