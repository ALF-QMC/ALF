...
\algnewcommand{\OneIndentedLeftComment}[1]{\Statex \(\hspace\algorithmicindent\triangleright\) \textit{#1}}
\algnewcommand{\TwoIndentedLeftComment}[1]{\Statex \(\hspace\algorithmicindent\hspace\algorithmicindent\triangleright\) \textit{#1}}
...
\algnewcommand{\CustomComment}[1]{\Statex \(\hspace{11.7em}\triangleright\) \textit{#1}}
\algnewcommand{\NewCustomComment}[1]{\Statex \(\hspace{13em}\triangleright\) \textit{#1}}
\begin{document}
...
% \hspace*{1em} Loop over sweeps. Each sweep updates twice (sweeping upward and downward\\
% \hspace*{1em} in time the whole space-time lattice of auxiliary fields.\\
...
% \hspace*{3em} Repeat the above steps (update, propagation, stabilization, equal time\\
% \hspace*{3em} measurements) for the downward direction in imaginary time\\
% \hspace*{2em} \textbf{Enddo}\\
% 
