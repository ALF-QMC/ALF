...
\newcommand{\ALFver}{2.2}        % version of ALF this documents
\newcommand{\ALFbranch}{ALF-2.2} % corresponding ALF branch 
\newcommand{\pyALFver}{2.2}      % version of pyALF this document refers to
\newcommand{\tutALFver}{2.2}     % version of the tutorial this document refers to
