...
! FOR THE USE IN ALF, WE ALWAYS WANT TO USE ZLIB
#define ZLIB 1
...
! THE FOLLOWING PART WAS COMMENTED OUT BY THE AUTHORS OF THE ALF PACKAGE
...
! #endif
!     if (.not.apipe) gzipped=isgzipped(filnam)
!     if (gzipped) then
! #if ZLIB
